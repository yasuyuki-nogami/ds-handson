...
ANSWERS.md                   ①②の穴埋めの答え（GitHubで表示して使う）
data/
...
### 穴埋めの答え（手が止まった人向け）
解答ノートは配布しません。下のページをGitHubで表示し、穴埋めの答えを見ながら自分で入力してください。
- 穴埋めの答え: https://github.com/yasuyuki-nogami/ds-handson/blob/main/ANSWERS.md
